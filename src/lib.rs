...
pub mod marlin {
    ...
    pub fn prove_and_verify_with_tall_matrix_big() {
        let num_constraints = 100;
        let num_variables = 25;

        println!("prove_and_verify_with_tall_matrix_big");
        test_circuit(num_constraints, num_variables);
    }

    pub fn prove_and_verify_with_tall_matrix_small() {
        let num_constraints = 26;
        let num_variables = 25;

        println!("prove_and_verify_with_tall_matrix_small");
        test_circuit(num_constraints, num_variables);
    }

    pub fn prove_and_verify_with_squat_matrix_big() {
        let num_constraints = 25;
        let num_variables = 100;

        println!("prove_and_verify_with_squat_matrix_big");
        test_circuit(num_constraints, num_variables);
    }

    pub fn prove_and_verify_with_squat_matrix_small() {
        let num_constraints = 25;
        let num_variables = 26;

        println!("prove_and_verify_with_squat_matrix_small");
        test_circuit(num_constraints, num_variables);
    }

    pub fn prove_and_verify_with_square_matrix() {
        let num_constraints = 25;
        let num_variables = 25;

        println!("prove_and_verify_with_square_matrix");
        test_circuit(num_constraints, num_variables);
    }

    /// Test on a constraint system that will trigger outlining.
    pub fn prove_and_test_outlining() {
        println!("prove_and_test_outlining");
        let rng = &mut ark_std::test_rng();
